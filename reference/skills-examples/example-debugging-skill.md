# Example: Debugging Methodology Skill

> This is a sanitized reference example based on production debugging skills.
> Use it as a model for creating your own debugging-focused skills.
...
3. **Verify Before Continuing** -- Worked? Move on. Didn't? Form NEW hypothesis.
4. **When You Don't Know** -- Say so. Research more.

### Phase 4: Implementation

1. **Create Failing Test Case** -- Simplest possible reproduction
2. **Implement Single Fix** -- ONE change addressing root cause
3. **Verify Fix** -- All tests pass, no regressions
4. **If 3+ Fixes Failed: Question Architecture** -- Stop fixing symptoms. Discuss fundamentals.
